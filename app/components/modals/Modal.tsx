    ...
    return (
        <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 focus:outline-none bg-neutral-800/70">
            <div className='relative w-full md:w-4/6 lg:w-3/6 xl:w-2/5 my-6 mx-auto h-full lg:h-auto md:h-auto'>
                ...
                `}>
                    <div className="translate h-full lg:h-auto md:h-auto border-0 rounded-lg overflow-hidden shadow-lg relative flex flex-col w-full outline-none focus:outline-none">
                        <div className="bg-white flex items-center p-6 rounded-t justify-center relative border-b-[1px]">
